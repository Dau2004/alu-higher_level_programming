...
OB        with self.assertRaisesRegex(TypeError, "width must be an integer"):
OBOB            Square(None)
OB
    def test_str_size(self):
OBOB        with self.assertRaisesRegex(TypeError, "width must be an integer"):
OB            Square("invalid")
...
OBOB            Square(5.5)
OB
OB    def test_complex_size(self):
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
OBOBOB            Square(complex(5))
...
OBOBOB        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            Square([1, 2, 3])
OBOB
...
OBOB    def test_tuple_size(self):
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            Square((1, 2, 3), 2, 3)

    def test_frozenset_size(self):
OB        with self.assertRaisesRegex(TypeError, "width must be an integer"):
OB            Square(frozenset({1, 2, 3, 1}))
